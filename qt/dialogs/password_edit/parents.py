...
# this file contains general password editing menu from which to be derived
...
class ControlLayout(QtWidgets.QGridLayout):
    def __init__(self, parent=None, accept_button_name='Accept'):
        ...
        # Setting the text fields for password data
        ...
        # There is a niche bug that this button can't be set to focused, there needs to be a small delay
        # So the function does the delay
    ...
    # Returns the password data from the text fields
    def get_values(self):
